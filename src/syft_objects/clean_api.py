...
class CleanSyftObject:
    ...
    def mock(self):
        ...
        return MockAccessor(self._CleanSyftObject__obj.mock, self._CleanSyftObject__obj)
    
    @property
    def private(self):
        """Access private-related properties and methods"""
        from .accessors import PrivateAccessor
        return PrivateAccessor(self._CleanSyftObject__obj.private, self._CleanSyftObject__obj)
